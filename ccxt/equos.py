...
class equos(Exchange):
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request = self.extend({'limit': limit}, request)
        response = self.publicGetGetTradeHistory(request)
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        self.privatePostCancelOrder(self.extend(request, params))
        return id
    ...
    def fetch_order(self, id, symbol=None, params={}):
        ...
        if symbol is not None:
            market = self.market(symbol)
        request['orderId'] = id
        orderHistoryResponse = self.privatePostGetOrderHistory(self.extend(request, params))
    ...
    def fetch_all_orders(self, symbol=None, since=None, limit=None, params={}):
    ...
    def fetch_cancelled_orders(self, symbol=None, since=None, limit=None, params={}):
        orders = self.fetch_orders(symbol, since, limit, params)
    ...
    def fetch_transactions(self, code=None, since=None, limit=None, params={}):
        deposits = self.fetch_deposits(code, since, None, params)
        withdrawals = self.fetch_withdrawals(code, since, None, params)
    ...
    def fetch_ledger(self, code=None, since=None, limit=None, params={}):
        ...
        # getUserHistory
        response = self.privatePostGetUserHistory(self.extend(request, params))
